...
export default function ManualInvoicePageStaff() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch('/api/staff/invoices/manual', {
        method: 'POST',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-6">
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-2xl font-bold">Manual Invoice Creation (Staff)</h1>
        </div>
        ...
        <div className="space-y-4 bg-white p-6 rounded shadow">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="outline" onClick={() => window.location.href = '/staff/invoices'}>
              Cancel
            </Button>
          </div>
        </div>
